...
[parameter_hat,RESNORM,EXITFLAG,OUTPUT]=fminunc(@ZeppelinStickSSD,NewStartx,h,meas,bvals,grad_dirs);

t2 = cputime - t1;

% Use NewBallStickSSD function to computes predicted signal and the sum of square differences
[sumRes, S_pred] =ZeppelinStickSSD(parameter_hat, meas, bvals, grad_dirs);
